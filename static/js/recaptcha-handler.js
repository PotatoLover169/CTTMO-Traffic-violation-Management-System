...
function loadReCaptchaScript() {
    ...
    console.log('Loading reCAPTCHA with configuration:', {
        siteKey: RECAPTCHA_CONFIG.siteKey,
        currentDomain: RECAPTCHA_CONFIG.domainConfig.currentDomain,
        allowedDomains: RECAPTCHA_CONFIG.domainConfig.allowedDomains,
    });
