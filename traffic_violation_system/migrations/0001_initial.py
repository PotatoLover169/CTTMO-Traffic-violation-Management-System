    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('general', 'General'), ('violation', 'Violation'), ('user', 'User'), ('payment', 'Payment'), ('system', 'System'), ('education', 'Education')], default='general', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='traffic_violation_system.userreport')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('or_cr_image', models.ImageField(blank=True, null=True, upload_to='vehicle_documents/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('ADJUDICATED', 'Adjudicated'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected'), ('PAID', 'Paid'), ('SETTLED', 'Settled'), ('CONTESTED', 'Contested'), ('HEARING_SCHEDULED', 'Hearing Scheduled'), ('DISMISSED', 'Dismissed'), ('EXPIRED', 'Expired'), ('ISSUED_DIRECT', 'Issued Direct')], default='PENDING', max_length=20)),
                ...
                ('refusal_note', models.TextField(blank=True, help_text='Reason for signature refusal', null=True)),
                ('signature_file', models.CharField(blank=True, help_text='Filename or path of the signature file', max_length=255, null=True)),
                ('direct_ticket_details', models.TextField(blank=True, null=True)),
                ('citation_number', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('issued_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='issued_direct_tickets', to=settings.AUTH_USER_MODEL)),
                ...
                ('rejected_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rejected_violations', to=settings.AUTH_USER_MODEL)),
